    ...
    <>
        ...
        <div class='item' style={{width: '100%'}}>
            <div style={{backgroundColor: '#c8c7cb', width: '100%', height: '50vh'}}>
                <img style={{width: '225px', position:'absolute', left: '-10px', top: '18vh'}} alt='img 1' src={l1_sh_img1}/>
                <img style={{width: '225px', position:'absolute', right: '-10px', top: '18vh'}} alt='img 2' src={l1_sh_img2}/>
            </div>
        ...
        <div class='item' style={{width: '100%'}}>
            <div style={{backgroundColor: '#0d121b', width: '100%', height: '50vh'}}>
                ...
                <img style={{width: '165px', position:'absolute', right: '85px', bottom: '-20vh'}} alt='img 1' src={l4shimg1}/>
        ...
        <div class='item' style={{width: '100%'}}>
            <div style={{backgroundColor: '#32cfeb', width: '100%', height: '50vh'}}>
                <img style={{width: '150px', position:'absolute', left: '5px', top: '-12vh'}} alt='img 1' src={l5shimg1}/>
                <img style={{width: '150px', position:'absolute', left: '150px', top: '-2vh'}} alt='img 2' src={l5shimg2}/>
                <img style={{width: '150px', position:'absolute', right: '-60px', bottom: '-7vh'}} alt='img 3' src={l5shimg3}/>
                <img style={{width: '150px', position:'absolute', left: '150px', bottom: '-23vh'}} alt='img 4' src={l5shimg4}/>
                <img style={{width: '150px', position:'absolute', left: '5px', bottom: '-12vh'}} alt='img 5' src={l5shimg5}/>
            </div>
