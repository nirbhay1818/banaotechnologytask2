  ...
  useEffect (()=>{
      ...
      document.addEventListener("scroll", e => {
          ...
          if (scrolled <= 362){
            ...
            setTop_p_text(['Biggest Classifieds', 'East Asia', 'Countries', 'ABC 412', 'We are the best', 'web development company', 'in the world', 'Coming Soon', 7])
    ...
    <>
        ...
        <div className='screen'>
            ...
            <div id={first_half_layer} className='firsthalf'>
                ...
                <img className={top_p_text[3] === 'ABC 123' ? 'fadein' : 'fadeout'} style={{width: '300px', marginLeft: '10%', marginTop: '50vh'}} alt='img' src={l1_fh_img}/>
                <img className={top_p_text[3] === 'ABC 412' ? 'fadein' : 'fadeout'} style={{width: '300px', marginLeft: '-40%', marginTop: '50vh'}} alt='img' src={l7fhimg}/>
                ...
                <div style={{width: '275px', color: 'white', marginLeft: '10%', marginTop: '-8vh',opacity:"0.6",fontWeight:"650",fontSize:"20px",letterSpacing:"1px"}}>
                    <ReactTextTransition
                        className='soon'
                        text={top_p_text[7]}
                        direction={text_transition_direction}
                ...
                <p style={{marginLeft: '80%', marginTop: '-2vh', color: 'white',fontWeight:'700'}}>S K I P</p>
            </div>

            <div id={second_half_layer} className='secondhalf'>
                <img className={top_p_text[3] === 'ABC 123' ? 'l1sheffectin' : 'l1sheffectout'} style={{marginLeft: '150px', position: 'absolute'}} alt='mobile img 1' src={l1_sh_img1}/>
                ...
                <img className={top_p_text[3] === 'ABC 567' ? 'l5shimg1effectin' : 'l5shimg1effectout'} style={{marginLeft: '190px', position: 'absolute'}} alt='mobile img 1' src={l5shimg1}/>
                ...
                <img className={top_p_text[3] === 'ABC 567' ? 'l5shimg5effectin' : 'l5shimg5effectout'} style={{marginLeft: '190px', position: 'absolute'}} alt='mobile img 5' src={l5shimg5}/>  
                <img className={top_p_text[3] === 'ABC 678' ? 'l6shimgeffectin' : 'l6shimgeffectout'} style={{position: 'absolute', width: '100%',height:"900px"}} alt='mobile img 1' src={l6shimg}/>  
                <img className={top_p_text[3] === 'ABC 412' ? 'l7shimg2effectin' : 'l7shimg2effectout'} style={{marginLeft: '650px', position: 'absolute'}} alt='mobile img 1' src={l7shimg2}/>  
                <img className={top_p_text[3] === 'ABC 412' ? 'l7shimg1effectin' : 'l7shimg1effectout'} style={{marginLeft: '200px', position: 'absolute'}} alt='mobile img 2' src={l7shimg1}/>  
            </div>
            ...
            <OwlCarousel items={1} loop autoplay autoplayTimeout={3000} autoplaySpeed={1000} dots>
                <div class='item' style={{width: '100%'}}>
                    <div style={{backgroundColor: '#c8c7cb', width: '100%', height: '50vh'}}>
                        ...
                        <img style={{width: '225px', position:'absolute', right: '55px', top: '7vh'}} alt='img 2' src={l1_sh_img2}/>
                    </div>
                ...
                <div class='item' style={{width: '100%'}}>
                    <div style={{backgroundColor: '#202462', width: '100%', height: '50vh'}}>
                        <img style={{width: '175px', position:'absolute', left: '75px', bottom: '50vh'}} alt='img 1' src={l2shimg1}/>
                        <img style={{width: '175px', position:'absolute', right: '75px', top: '0vh'}} alt='img 2' src={l2shimg2}/>
                    </div>
                ...
                <div class='item' style={{width: '100%'}}>
                    <div style={{backgroundColor: '#15194a', width: '100%', height: '50vh'}}>
                        <img style={{width: '200px', position:'absolute', left: '50px', bottom: '-18vh'}} alt='img 1' src={l3shimg1}/>
                        <img style={{width: '165px', position:'absolute', right: '50px', top: '-10vh'}} alt='img 2' src={l3shimg2}/>
                    </div>
                ...
                <div class='item' style={{width: '100%'}}>
                    <div style={{backgroundColor: '#0d121b', width: '100%', height: '50vh'}}>
                        <img style={{width: '165px', position:'absolute', left: '50px', bottom: '-10vh'}} alt='img 1' src={l4shimg1}/>
                        <img style={{width: '165px', position:'absolute', right: '100px', top: '-7vh'}} alt='img 2' src={l4shimg2}/>
                        <img style={{width: '165px', position:'absolute', right: '100px', bottom: '-23vh'}} alt='img 1' src={l4shimg1}/>
                        <img style={{width: '165px', position:'absolute', left: '10px', top: '2vh'}} alt='img 3' src={l4shimgpizza}/>
                    </div>
                ...
                <div class='item' style={{width: '100%'}}>
                    <div style={{backgroundColor: '#32cfeb', width: '100%', height: '50vh'}}>
                        ...
                        <img style={{width: '150px', position:'absolute', right: '55px', bottom: '-7vh'}} alt='img 3' src={l5shimg3}/>
                ...
                <div class='item' style={{width: '100%'}}>
                    <div style={{backgroundColor: 'white', width: '100%', height: '50vh'}}>
                        <img style={{ position:'absolute',bottom:"-50px"}} alt='img 1' src={l6shimg}/>
                    </div>
                ...
                <div class='item' style={{width: '100%'}}>
                    <div style={{backgroundColor: '#4bb76a', width: '100%', height: '50vh'}}>
                        <img style={{width: '305px', zIndex:'1', position:'absolute', left: '20px', top: '6vh'}} alt='img 1' src={l7shimg1}/>
                        <img style={{width: '255px', position:'relative', right: '-210px', top: '10vh'}} alt='img 2' src={l7shimg2}/>
                    </div>
